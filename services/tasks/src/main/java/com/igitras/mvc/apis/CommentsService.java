...
import com.igitras.domain.model.CommentCollectionResource;
import com.igitras.domain.model.CommentResource;
...
public class CommentsService {
     ...
     * @return
     */
    @HystrixCommand(fallbackMethod = "getFallbackCommentsForTask",
