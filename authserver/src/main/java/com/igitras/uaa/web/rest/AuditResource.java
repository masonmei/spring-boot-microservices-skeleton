...
import static com.igitras.common.utils.Constants.DataFormatter.DATE_FORMAT;

import com.igitras.common.utils.PaginationUtil;
import com.igitras.uaa.service.AuditEventService;
 ...
 */
@RestController
@RequestMapping("management/uaa/audits")
public class AuditResource {
    ...
    public ResponseEntity<List<AuditEvent>> getByDates(
            @RequestParam(value = "fromDate") @DateTimeFormat(pattern = DATE_FORMAT) LocalDate fromDate,
            @RequestParam(value = "toDate") @DateTimeFormat(pattern = DATE_FORMAT) LocalDate toDate, Pageable pageable)
