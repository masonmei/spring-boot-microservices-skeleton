...
import com.igitras.uaa.web.dto.KeyAndPasswordDto;
import com.igitras.uaa.web.dto.ManagedUserDto;
import com.igitras.uaa.web.dto.UserDto;
                ...
                .orElseGet(() -> userRepository.findOneByEmail(managedUserDto.getEmail())
                        ...
                        .orElseGet(() -> {
                            User user = userService.createUserInformation(managedUserDto.getLogin(),
                                    ...
                                    managedUserDto.getLastName(), managedUserDto.getEmail()
                                            .toLowerCase(), managedUserDto.getLangKey());
